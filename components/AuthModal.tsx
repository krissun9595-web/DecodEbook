      ...
      <div className="w-full max-w-sm p-8 relative z-10">
        <div className="text-center mb-8">
          <div className="flex items-center justify-center gap-2 mb-4">
            <Terminal size={28} className="text-[#00f3ff]" />
          </div>
        ...
        {inAppBrowser && (
          <div className="mb-4 p-3 bg-amber-950/20 border border-amber-900/40 rounded-lg space-y-2">
            ...
            <button
              onClick={onSkip}
              className="w-full py-2 bg-[#00f3ff] text-black font-bold rounded text-[10px] font-mono uppercase tracking-widest hover:bg-[#00c2cc] transition-all flex items-center justify-center gap-1.5"
            >
