...
export const PDF_TEXT_EXTRACTION_VERSION = 'pdf-text-v226-toc-continuation-and-region-reject';
...
export const EPUB_TEXT_EXTRACTION_VERSION = 'epub-text-v72-part-hash-heading';
