...
export const PDF_TEXT_EXTRACTION_VERSION = 'pdf-text-v193-seam-hang-nbsp-keep';
...
export const EPUB_TEXT_EXTRACTION_VERSION = 'epub-text-v39-close-selfclosing-nonvoid';
