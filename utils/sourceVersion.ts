...
export const PDF_TEXT_EXTRACTION_VERSION = 'pdf-text-v215-watermark-filter';
...
export const EPUB_TEXT_EXTRACTION_VERSION = 'epub-text-v67-figure-page-not-heading';
