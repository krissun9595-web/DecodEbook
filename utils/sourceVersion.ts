...
export const PDF_TEXT_EXTRACTION_VERSION = 'pdf-text-v232-attribution-italic-continuation';
...
export const EPUB_TEXT_EXTRACTION_VERSION = 'epub-text-v73-figure-width-tier';
