...
export type CachedFileType = 'source-file' | 'original-file' | 'audio' | 'podcast-audio' | 'podcast-script' | 'video' | 'concept-image' | 'sticky-note' | 'mind-map-pdf' | 'mind-map-docx' | 'mind-map-xmind' | 'chapter-text' | 'translation' | 'translation-mem' | 'figure-image' | 'notebook-figure';
